...
class DynamicParser {
  ...
  static KsqlApiClient.KsqlResponseTable parseArray(String tableName, JsonNode array) {
    return parseArray(tableName, getFieldNamesFromArray(array), array);
  }

  static KsqlApiClient.KsqlResponseTable parseArray(String tableName,
  ...
  static KsqlApiClient.KsqlResponseTable parseObject(String tableName, JsonNode node) {
    if (!node.isObject()) {
      return KsqlApiClient.KsqlResponseTable.builder()
          .header(tableName)
  ...
  static KsqlApiClient.KsqlResponseTable parseObject(String tableName, List<String> columnNames, JsonNode node) {
    return KsqlApiClient.KsqlResponseTable.builder()
        .header(tableName)
        .columnNames(columnNames)
        .values(
