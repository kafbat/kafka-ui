...
Given('Brokers is visible', async function (this: PlaywrightCustomWorld) {
  await this.page.goto(process.env.BASEURL!);
  await expect(this.locators.panel.brokersLink()).toBeVisible();
});

When('click on Brokers link', async function (this: PlaywrightCustomWorld) {
  await this.locators.panel.brokersLink().click();
});

Then('Brokers heading visible', async function (this: PlaywrightCustomWorld) {
  await this.locators.brokers.brokersHeading().waitFor({ state: 'visible' });
});

Given('Topics is visible', async function (this: PlaywrightCustomWorld) {
  await this.page.goto(process.env.BASEURL!);
  await expect(this.locators.panel.topicsLink()).toBeVisible();
});

When('click on Topics link', async function (this: PlaywrightCustomWorld) {
  await this.locators.panel.topicsLink().click();
});

Then('Topics heading visible', async function (this: PlaywrightCustomWorld) {
  await this.locators.topics.topicsHeading().waitFor({ state: 'visible' });
});

Given('Consumers is visible', async function (this: PlaywrightCustomWorld) {
  await this.page.goto(process.env.BASEURL!);
  await expect(this.locators.panel.consumersLink()).toBeVisible();
});

When('click on Consumers link', async function (this: PlaywrightCustomWorld) {
  await this.locators.panel.consumersLink().click();
});

Then('Consumers heading visible', async function (this: PlaywrightCustomWorld) {
  await this.locators.consumers.consumersHeading().waitFor({ state: 'visible' });
});

Given('Schema Registry is visible', async function (this: PlaywrightCustomWorld) {
  await this.page.goto(process.env.BASEURL!);
  await expect(this.locators.panel.schemaRegistryLink()).toBeVisible();
});

When('click on Schema Registry link', async function (this: PlaywrightCustomWorld) {
  await this.locators.panel.schemaRegistryLink().click();
});

Then('Schema Registry heading visible', async function (this: PlaywrightCustomWorld) {
  await this.locators.schemaRegistry.schemaRegistryHeading().waitFor({ state: 'visible' });
});

Given('Kafka Connect is visible', async function (this: PlaywrightCustomWorld) {
  await this.page.goto(process.env.BASEURL!);
  await expect(this.locators.panel.kafkaConnectLink()).toBeVisible();
});

When('click on Kafka Connect link', async function (this: PlaywrightCustomWorld) {
  await this.locators.panel.kafkaConnectLink().click();
});

Then('Kafka Connect heading visible', async function (this: PlaywrightCustomWorld) {
  await this.locators.connectors.connectorsHeading().waitFor({ state: 'visible' });
});

Given('KSQL DB is visible', async function (this: PlaywrightCustomWorld) {
  await this.page.goto(process.env.BASEURL!);
  await expect(this.locators.panel.ksqlDbLink()).toBeVisible();
});

When('click on KSQL DB link', async function (this: PlaywrightCustomWorld) {
  await this.locators.panel.ksqlDbLink().click();
});

Then('KSQL DB heading visible', async function (this: PlaywrightCustomWorld) {
  await this.locators.ksqlDb.ksqlDbHeading().waitFor({ state: 'visible' });
});

Given('Dashboard is visible', async function (this: PlaywrightCustomWorld) {
  await this.page.goto(process.env.BASEURL!);
  await expect(this.locators.panel.getDashboardLink()).toBeVisible();
});

When('click on Dashboard link', async function (this: PlaywrightCustomWorld) {
...
Then('Dashboard heading visible', async function (this: PlaywrightCustomWorld) {
