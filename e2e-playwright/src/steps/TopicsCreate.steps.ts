...
Given('Topics AddATopic clicked', async () => {
  const button = scenarioContext.topics!.topicAddTopicButton();
  await expect(button).toBeVisible();
  await button.click();
});

Given('TopicCreate heading visible is: {string}', async (visible: string) => {
  await expectVisibility(scenarioContext.topicsCreate!.topicsCreateHeading(), visible);
});

Given('TopicCreate TopicName input visible is: {string}', async (visible: string) => {
  await expectVisibility(scenarioContext.topicsCreate!.topicsCreateTopicName(), visible);
});

Given('TopicCreate NumberOfPartitions input visible is: {string}', async (visible: string) => {
  await expectVisibility(scenarioContext.topicsCreate!.topicsCreateNumberOfPartitions(), visible);
});

Given('TopicCreate CleanupPolicy select visible is: {string}', async (visible: string) => {
  await expectVisibility(scenarioContext.topicsCreate!.topicsCreateCleanupPolicy(), visible);
});

Given('TopicCreate MinInSyncReplicas input visible is: {string}', async (visible: string) => {
  await expectVisibility(scenarioContext.topicsCreate!.topicsCreateMinInSyncReplicas(), visible);
});

Given('TopicCreate ReplicationFactor input visible is: {string}', async (visible: string) => {
  await expectVisibility(scenarioContext.topicsCreate!.topicsCreateReplicationFactor(), visible);
});

Given('TopicCreate TimeToRetainData input visible is: {string}', async (visible: string) => {
  await expectVisibility(scenarioContext.topicsCreate!.topicsCreateTimeToRetainData(), visible);
});

Given('TopicCreate 12Hours button visible is: {string}', async (visible: string) => {
  await expectVisibility(scenarioContext.topicsCreate!.topicsCreate12Hours(), visible);
});

Given('TopicCreate 1Day button visible is: {string}', async (visible: string) => {
  await expectVisibility(scenarioContext.topicsCreate!.topicsCreate1Day(), visible);
});

Given('TopicCreate 2Day button visible is: {string}', async (visible: string) => {
  await expectVisibility(scenarioContext.topicsCreate!.topicsCreate2Day(), visible);
});

Given('TopicCreate 7Day button visible is: {string}', async (visible: string) => {
  await expectVisibility(scenarioContext.topicsCreate!.topicsCreate7Day(), visible);
});
...
Given('TopicCreate MaxPartitionSize select visible is: {string}', async (visible: string) => {
  await expectVisibility(scenarioContext.topicsCreate!.topicsCreateMaxPartitionSize(), visible);
});

Given('TopicCreate MaxMessageSize input visible is: {string}', async (visible: string) => {
  await expectVisibility(scenarioContext.topicsCreate!.topicsCreateMaxMessageSize(), visible);
});

Given('TopicCreate AddCustomParameter button visible is: {string}', async (visible: string) => {
  await expectVisibility(scenarioContext.topicsCreate!.topicsCreateAddCustomParameter(), visible);
});

Given('TopicCreate Cancel button visible is: {string}', async (visible: string) => {
  await expectVisibility(scenarioContext.topicsCreate!.topicsCreateCancel(), visible);
});

Given('TopicCreate CreateTopic button visible is: {string}', async (visible: string) => {
  await expectVisibility(scenarioContext.topicsCreate!.topicCreateCreateTopicButton(), visible);
});
...
When('TopicCreate Topic name starts with: {string}', async function (this: CustomWorld, prefix: string) {
  ...
  await scenarioContext.topicsCreate!.topicsCreateTopicName().fill(topicName);
});

When('TopicCreate Number of partitons: {int}', async function (this: CustomWorld, count: number) {
  await scenarioContext.topicsCreate!.topicsCreateNumberOfPartitions().fill(count.toString());
});

When('TopicCreate Time to retain data one day', async function () {
  await scenarioContext.topicsCreate!.topicsCreate1Day().click();
});

When('TopicCreate Create topic clicked', async function () {
  await scenarioContext.topicsCreate!.topicCreateCreateTopicButton().click();
});
...
Then('Header starts with: {string}', async function (this: CustomWorld, prefix: string) {
  ...
  const header = stepsContext.page.getByRole('heading', { name: topicName });
...
When('TopicCreate 12Hours button clicked', async () => {
  await scenarioContext.topicsCreate!.topicsCreate12Hours().click();
});
...
When('TopicCreate 2Day button clicked', async () => {
  await scenarioContext.topicsCreate!.topicsCreate2Day().click();
});

When('TopicCreate 7Day button clicked', async () => {
  await scenarioContext.topicsCreate!.topicsCreate7Day().click();
});

When('TopicCreate 4Weeks button clicked', async () => {
  await scenarioContext.topicsCreate!.topicsCreate4Weeks().click();
});
