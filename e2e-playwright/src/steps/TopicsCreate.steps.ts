...
Given('Topics AddATopic clicked', async function (this: PlaywrightCustomWorld) {
...
When('TopicCreate Time to retain data one day', async function (this: PlaywrightCustomWorld) {
  await this.locators.topicsCreate.topicsCreate1Day().click();
});

When('TopicCreate Create topic clicked', async function (this: PlaywrightCustomWorld) {
...
When('TopicCreate 12Hours button clicked', async function (this: PlaywrightCustomWorld) {
  await this.locators.topicsCreate.topicsCreate12Hours().click();
});

When('TopicCreate 1Day button clicked', async function (this: PlaywrightCustomWorld) {
  await this.locators.topicsCreate.topicsCreate1Day().click();
});

When('TopicCreate 2Day button clicked', async function (this: PlaywrightCustomWorld) {
  await this.locators.topicsCreate.topicsCreate2Day().click();
});

When('TopicCreate 7Day button clicked', async function (this: PlaywrightCustomWorld) {
  await this.locators.topicsCreate.topicsCreate7Day().click();
});

When('TopicCreate 4Weeks button clicked', async function (this: PlaywrightCustomWorld) {
